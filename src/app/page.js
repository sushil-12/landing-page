  ...
  return (
    <main>
      <section className="text-gray-700 body-font">
        <div className=" mx-auto flex px-32 py-30 md:flex-row flex-col items-center bg-primary">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">
              From the Roots of the Balkans, We Rise Together.
            ...
            <div className="flex justify-center">
              <button className="inline-flex text-white bg-danger border-0 py-2 px-6 focus:outline-none  rounded text-lg">
                Request to Join
              </button>
            </div>
          </div>
