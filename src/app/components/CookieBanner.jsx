...
const CookieBanner = () => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 z-50 flex items-center justify-center p-4 w-full">
            <div className="w-[90%] flex justify-around items-center p-4 rounded-lg shadow-xl bg-primary ">
