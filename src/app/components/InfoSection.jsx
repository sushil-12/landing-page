...
const InfoSection = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center md:gap-14 lg:gap-28 w-full text-center lg:text-left">
      ...
      <div className="w-full md:w-1/2 text-white  max-w-lg">
        ...
        <div className="block lg:hidden mb-4 items-center justify-center place-content-center text-center justify-items-center">
