...
const InfoSection = () => {
  return (
    <div className=" flex flex-col md:flex-row items-center justify-center gap-28 w-full">
      ...
      <div className="w-full md:w-1/2 text-white  max-w-lg">
        <h1 className=" text-[38px] font-semibold poppins-semibold mb-4 ">Join the Balkan Org!<br /> A Gateway to Connection and Discovery</h1>
